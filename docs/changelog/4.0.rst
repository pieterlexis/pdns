...
-  `#4526 <https://github.com/PowerDNS/pdns/pull/4526>`__: API: url in zone info should be absolute (Christian Hofstaedtler)
...
-  `#5667 <https://github.com/PowerDNS/pdns/pull/5667>`__: Handle AFSDB record separately in ZoneParser. (Johan Jatko)
...
-  `#5733 <https://github.com/PowerDNS/pdns/pull/5733>`__: Add DNSSEC test vectors for RSA, ECDSA, ed25519 and GOST
